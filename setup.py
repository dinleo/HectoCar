...
def write_version_file():
    version_path = os.path.join(cwd, "models/groundingdino", "version.py")
...
def get_extensions():
    ...
    extensions_dir = os.path.join(this_dir, "models", "groundingdino", "model", "csrc")
